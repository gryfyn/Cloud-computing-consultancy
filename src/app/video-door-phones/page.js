...
const INSTALL_TYPES = [
  {
    ...
    desc: "Our video door phone systems are perfectly suited to apartment living — allowing residents to see and speak with visitors at the main entrance without leaving their unit. Integrated with building access control, one touch grants or denies entry from the comfort of your home.",
    icon: "M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6",
    img: "https://images.unsplash.com/photo-1545324418-cc1a3fa10c00?w=800&q=80",
    examples: ["Multi-Unit Support", "Main Door Access", "Audio & Video", "One-Touch Entry"],
  },
  {
    acronym: "Villas",
    name: "Villas, Bungalows & Homes",
    desc: "Protect your family without compromising on comfort. Our villa and bungalow installations place HD video door stations at every entrance point, giving homeowners crystal-clear visibility of who is at the gate before granting access — day or night, rain or shine.",
    icon: "M8 14v3m4-3v3m4-3v3M3 21h18M3 10h18M3 7l9-4 9 4M4 10h16v11H4V10z",
    img: "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=800&q=80",
    examples: ["Gate Stations", "HD Night Vision", "Indoor Monitor", "Family Security"],
  },
  {
    acronym: "Office",
    name: "Offices & Commercial Spaces",
    desc: "Control who enters your workplace with confidence. Video door phones for offices enable receptionists or any staff member to visually verify visitors before remotely unlocking the door — eliminating unauthorised access and enhancing the professional experience for genuine guests.",
    icon: "M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4",
    img: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=800&q=80",
    examples: ["Remote Door Release", "Visitor Logging", "Multi-Floor Systems", "Receptionist Integration"],
  },
  {
    acronym: "Banks",
    name: "Banks, Strong Rooms & Secure Facilities",
    desc: "For environments where security is paramount, our high-security video door phone installations provide robust access control at strong room entrances, chambers, and vaults. Two-way communication and visual verification ensure only authorised personnel gain access to sensitive areas.",
    icon: "M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z",
    img: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=800&q=80",
    examples: ["Vault Access Control", "Two-Way Comms", "Tamper-Resistant", "Audit Trail"],
  },
  {
    acronym: "Hotels",
    name: "Hotels, Conference Halls & Institutions",
    desc: "From hotel room doors to conference suite entrances and institutional chambers, our systems provide seamless visitor management at scale. Guests and delegates enjoy a frictionless, professional experience while your security team retains complete control over who enters.",
    icon: "M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z",
    img: "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=800&q=80",
    examples: ["Room-Level Access", "Lobby Integration", "Conference Suites", "Scalable Deployment"],
  },
];
...
const BENEFITS = [
  {
    title: "See Before You Open",
    body: "Know exactly who is at your door before you open it. A clear audio-visual connection between you and your visitor means you are never surprised — and never at risk.",
  ...
  {
    title: "No Physical Contact Required",
    body: "Communicate with and admit visitors without physically going to the door. Ideal for high-rise apartments, busy offices, or any space where manual verification is impractical or unsafe.",
    icon: "M18.364 5.636l-3.536 3.536m0 5.656l3.536 3.536M9.172 9.172L5.636 5.636m3.536 9.192l-3.536 3.536M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-5 0a4 4 0 11-8 0 4 4 0 018 0z",
    img: "https://images.unsplash.com/photo-1563986768609-322da13575f3?w=600&q=80",
  },
  {
    title: "Access Control Integration",
    body: "Video door phones integrate seamlessly with access control systems, intrusion detection, and home automation — creating a unified security and safety ecosystem for your property.",
    icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z",
    img: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=600&q=80",
  },
  {
    title: "Professional Installation",
    body: "Our certified technicians handle the full installation — from cabling and mounting to configuration and testing. Every system is commissioned to work flawlessly from day one.",
  ...
  },
  {
    ...
    body: "Integrate your video door phone with your smart home or building management system. Trigger lights, unlock doors, or alert your security team — all from a single connected platform.",
    icon: "M13 10V3L4 14h7v7l9-11h-7z",
    img: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&q=80",
  },
  {
    title: "Trusted Technical Support",
    body: "Our relationship doesn't end at installation. We provide responsive technical support and customer service to ensure your video door phone system continues to perform at its best.",
...
// ── Gallery ──
const GALLERY = [
  { label: "Residential Security",  img: "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=700&q=80", span: 2 },
  { label: "Office Access",         img: "https://images.unsplash.com/photo-1497366216548-37526070297c?w=700&q=80", span: 1 },
  { label: "Secure Entry",          img: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=700&q=80", span: 1 },
  { label: "Hotel & Hospitality",   img: "https://images.unsplash.com/photo-1566073771259-6a8506099945?w=700&q=80", span: 2 },
];

// ── Why choose Cloud CompCon ──
const WHY = [
  { stat: "5+",   label: "Installation Environments",  desc: "Flats, villas, offices, banks, hotels — we deploy video door phone systems across every type of premises." },
  { stat: "24/7", label: "Technical Support",           desc: "Your system monitored and supported around the clock. Any issue is addressed before it affects your security." },
  { stat: "100%", label: "Integration Ready",           desc: "Access control, intrusion detection, home automation — our systems connect with your existing security ecosystem." },
  { stat: "Pro",  label: "Certified Installation",      desc: "Highly professional installation from certified engineers — delivering a remarkable experience from day one." },
];
  ...
  return (
    <div style={{ backgroundColor: "var(--background)", color: "var(--foreground)", fontFamily: "var(--font-sans)", minHeight: "100vh" }}>
      ...
      <main style={{ paddingTop: "var(--nav-height)" }}>
          ...
          <div style={{ position: "relative", zIndex: 10, maxWidth: "var(--max-width)", margin: "0 auto", padding: "0 1.5rem", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 56, alignItems: "center" }}>
            <div>
              <div ref={introBadgeRef} style={{ opacity: 0, display: "inline-flex", alignItems: "center", gap: 8, padding: "5px 14px", borderRadius: "9999px", border: "1px solid var(--primary-30-border)", backgroundColor: "var(--primary-05-bg)", color: "var(--primary)", fontSize: "0.72rem", fontWeight: 700, marginBottom: 28, letterSpacing: "0.14em", textTransform: "uppercase" }}>
                ...
                Network Services · Video Door Phones
              </div>
              <h1 ref={introH1Ref} style={{ opacity: 0, fontSize: "clamp(2.6rem, 5.5vw, 4.5rem)", fontWeight: 700, lineHeight: 1.07, marginBottom: 24, color: "var(--foreground)" }}>
                See Who's There{" "}
                <span style={{ color: "var(--primary)" }}>Before You Open</span>
              </h1>
              <p ref={introParaRef} style={{ opacity: 0, fontSize: "1.1rem", color: "var(--text-muted)", marginBottom: 40, maxWidth: 520, lineHeight: 1.85 }}>
                Cloud Computing Consultancy brings everything you would expect from a trusted{" "}
                <strong style={{ color: "var(--foreground)" }}>Video Door Phone solutions provider</strong> — from highly professional installation to great technical support — creating a remarkable security experience for every user.
              </p>
            ...
            <div ref={introImgRef} style={{ opacity: 0, position: "relative" }}>
              <div style={{ borderRadius: "1rem", overflow: "hidden", border: "1px solid var(--border-subtle)", boxShadow: "0 32px 64px rgba(0,0,0,0.5)" }}>
                <div style={{ padding: "12px 16px", borderBottom: "1px solid var(--border-subtle)", display: "flex", alignItems: "center", justifyContent: "space-between", backgroundColor: "rgba(255,255,255,0.03)" }}>
                  ...
                  <span style={{ fontSize: "0.7rem", color: "var(--text-subtle)", fontWeight: 600 }}>Video Door Phone System</span>
                ...
                <img
                  ...
                  alt="Video Door Phone Installation"
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", borderTop: "1px solid var(--border-subtle)", backgroundColor: "var(--surface)" }}>
                  {[
                    { val: "HD",    lbl: "Video Quality" },
                    { val: "2-Way", lbl: "Audio Comms" },
              ...
              <div style={{ position: "absolute", top: -22, right: -22, width: 90, height: 90, borderRadius: "50%", overflow: "hidden", border: "3px solid var(--background)", boxShadow: "0 8px 24px rgba(0,0,0,0.4)" }}>
                <img src="https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=300&q=80" alt="" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
              </div>
            </div>
          </div>
        </section>
        ...
        <section style={{ padding: "3.5rem 0", backgroundColor: "#ffffff", borderTop: "1px solid #e5e7eb", borderBottom: "1px solid #e5e7eb" }}>
          <div style={{ maxWidth: "var(--max-width)", margin: "0 auto", padding: "0 1.5rem" }}>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", borderRadius: "1rem", overflow: "hidden", border: "1px solid #e5e7eb" }}>
              {[
                { icon: "M15 10l4.553-2.069A1 1 0 0121 8.82V15.18a1 1 0 01-1.447.89L15 14M3 8a2 2 0 012-2h8a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V8z", text: "HD audio-visual — see & speak clearly" },
                { icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z", text: "No physical contact — remote door release" },
                { icon: "M13 10V3L4 14h7v7l9-11h-7z", text: "Integrates with access & home automation" },
                { icon: "M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z M15 12a3 3 0 11-6 0 3 3 0 016 0z", text: "Professional installation & ongoing support" },
              ].map((item, i) => (
                <div key={i}
        ...
        {/* ══════════════════════════════════════
            WHAT IS VIDEO DOOR PHONE  (white — editorial)
        ══════════════════════════════════════ */}
          ...
          <div style={{ maxWidth: "var(--max-width)", margin: "0 auto", padding: "0 1.5rem", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 72, alignItems: "center" }}>
            <div style={{ position: "relative" }}>
              <div style={{ borderRadius: "1rem", overflow: "hidden", boxShadow: "0 20px 60px rgba(0,0,0,0.12)" }}>
                <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=900&q=80" alt="Video Door Phone" style={{ width: "100%", height: 420, objectFit: "cover", display: "block" }} />
              </div>
              <div style={{ position: "absolute", bottom: -20, right: -20, padding: "16px 22px", borderRadius: "1rem", backgroundColor: "var(--primary)", boxShadow: "0 12px 32px rgba(129,194,63,0.4)" }}>
                ...
                <p style={{ fontSize: "0.78rem", fontWeight: 700, color: "#0a0a0a" }}>Premises Types</p>
              </div>
              <div style={{ position: "absolute", top: -20, left: -20, padding: "14px 18px", borderRadius: "1rem", backgroundColor: "#0a0a0a", border: "1px solid rgba(129,194,63,0.3)", boxShadow: "0 8px 24px rgba(0,0,0,0.3)" }}>
                <p style={{ fontSize: "0.72rem", fontWeight: 700, color: "var(--primary)", marginBottom: 2 }}>Security Must Be First</p>
                <p style={{ fontSize: "0.68rem", color: "rgba(255,255,255,0.6)" }}>Homes, offices & beyond</p>
              </div>
            </div>

            <div>
              <p style={{ fontSize: "0.72rem", fontWeight: 700, color: "var(--primary)", letterSpacing: "0.18em", textTransform: "uppercase", marginBottom: 14 }}>What Is a Video Door Phone?</p>
              <h2 style={{ fontSize: "clamp(1.75rem, 2.8vw, 2.4rem)", fontWeight: 700, color: "#111", lineHeight: 1.2, marginBottom: 20 }}>
                Security Must Be<br />Your First Priority
              </h2>
              <p style={{ color: "#555", lineHeight: 1.85, marginBottom: 18, fontSize: "0.95rem" }}>
                A Video Door Phone is a video and audio device placed near your property's main entrance that lets you <strong>clearly see and speak with whoever is outside</strong> before you decide to open the door. It's a digital communication system used to regulate entry — providing audio-visual communication between indoor occupants and outside guests.
              </p>
              <p style={{ color: "#555", lineHeight: 1.85, marginBottom: 18, fontSize: "0.95rem" }}>
                Security equipment is of dominant importance for industrial, commercial, and residential properties alike. In a world of constant connectivity, we must place the same emphasis on <strong>interactivity in terms of our own personal security</strong>.
              </p>
              <p style={{ color: "#555", lineHeight: 1.85, marginBottom: 32, fontSize: "0.95rem" }}>
                Our Video Door Phone systems can be seamlessly <strong style={{ color: "var(--primary)" }}>integrated with access control, intrusion detection, and home automation</strong> solutions — creating a complete, connected security ecosystem for your property.
              </p>
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                {[
                  "Suitable for flats, villas, offices, banks, hotels, conference halls and more",
                  "Two-way audio and video — communicate clearly without opening the door",
                  "Remote door release — admit visitors from anywhere inside your property",
                ].map((pt, i) => (
        ...
        <section id="benefits" style={{ padding: "6rem 0", backgroundColor: "#f9fafb", borderTop: "1px solid #e5e7eb" }}>
          <div style={{ maxWidth: "var(--max-width)", margin: "0 auto", padding: "0 1.5rem" }}>
            <div ref={benefitHeadRef} style={{ opacity: 0, textAlign: "center", marginBottom: 56 }}>
              <p style={{ fontSize: "0.75rem", fontWeight: 700, color: "var(--primary)", letterSpacing: "0.18em", textTransform: "uppercase", marginBottom: 10 }}>Why Video Door Phones</p>
              <h2 style={{ fontSize: "clamp(1.875rem, 3vw, 2.75rem)", fontWeight: 700, color: "#111", marginBottom: 16 }}>
                Benefits of Our Video Door Phone Solutions
              </h2>
              <p style={{ color: "#555", maxWidth: 560, margin: "0 auto", lineHeight: 1.8 }}>
                From enhanced personal security to seamless integration with your wider smart home or building management system — a video door phone is one of the most impactful upgrades you can make.
              </p>
        ...
        <section style={{ padding: "6rem 0", backgroundColor: "#ffffff", borderTop: "1px solid #e5e7eb" }}>
          <div style={{ maxWidth: "var(--max-width)", margin: "0 auto", padding: "0 1.5rem" }}>
            <div ref={modelHeadRef} style={{ opacity: 0, textAlign: "center", marginBottom: 64 }}>
              <p style={{ fontSize: "0.75rem", fontWeight: 700, color: "var(--primary)", letterSpacing: "0.18em", textTransform: "uppercase", marginBottom: 10 }}>Where We Install</p>
              <h2 style={{ fontSize: "clamp(1.875rem, 3vw, 2.75rem)", fontWeight: 700, color: "#111", marginBottom: 16 }}>
                Video Door Phone Solutions for Every Premises
              </h2>
              <p style={{ color: "#555", maxWidth: 560, margin: "0 auto", lineHeight: 1.8 }}>
                Our systems are deployed across a wide range of environments — each installation tailored to the specific access control and communication needs of the premises.
              </p>
              <div style={{ width: 72, height: 5, backgroundColor: "var(--primary)", margin: "22px auto 0", borderRadius: 9999 }} />
            </div>
            <div ref={modelRef} style={{ display: "flex", flexDirection: "column", gap: 20 }}>
              {INSTALL_TYPES.map((m, i) => (
        ...
        <section style={{ padding: "6rem 0", backgroundColor: "var(--background)", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative", zIndex: 10, maxWidth: "var(--max-width)", margin: "0 auto", padding: "0 1.5rem" }}>
            <div ref={galleryHeadRef} style={{ opacity: 0, textAlign: "center", marginBottom: 48 }}>
              <p style={{ fontSize: "0.75rem", fontWeight: 700, color: "var(--primary)", letterSpacing: "0.18em", textTransform: "uppercase", marginBottom: 10 }}>Where We Work</p>
              <h2 style={{ fontSize: "clamp(1.875rem, 3vw, 2.75rem)", fontWeight: 700, color: "var(--foreground)", marginBottom: 14 }}>
                Securing Every Entry Point<br />Across Every Premises
              </h2>
              <p style={{ color: "var(--text-muted)", maxWidth: 500, margin: "0 auto", lineHeight: 1.75 }}>
                From residential front doors to high-security bank vaults — we design, supply, and install video door phone systems that genuinely protect.
              </p>
              <div style={{ width: 72, height: 5, backgroundColor: "var(--primary)", margin: "22px auto 0", borderRadius: 9999 }} />
            </div>
        ...
        <section style={{ backgroundColor: "var(--primary)", padding: "5rem 0", overflow: "hidden", position: "relative" }}>
          ...
          <div style={{ position: "absolute", top: 0, right: 0, width: "28%", height: "100%", overflow: "hidden", opacity: 0.15 }}>
            <img src="https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=600&q=80" alt="" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
          </div>
          <div style={{ position: "relative", zIndex: 10, maxWidth: "var(--max-width)", margin: "0 auto", padding: "0 1.5rem", display: "flex", flexWrap: "wrap", gap: 48, alignItems: "center", justifyContent: "space-between" }}>
            <div style={{ flex: 1, minWidth: 260 }}>
              ...
              <h2 style={{ fontSize: "clamp(2rem, 4vw, 3rem)", fontWeight: 700, color: "#0a0a0a", lineHeight: 1.15, marginBottom: 20 }}>
                Security should never<br />be an afterthought
              </h2>
              <p style={{ color: "rgba(0,0,0,0.72)", fontSize: "1.05rem", lineHeight: 1.8, maxWidth: 520 }}>
                Cloud CompCon is the most trusted Video Door Phone solutions provider — offering the <strong>professional installation, integration expertise, and ongoing support</strong> that makes your home or business truly secure.
              </p>
            </div>
          ...
          <div style={{ maxWidth: "var(--max-width)", margin: "0 auto", padding: "0 1.5rem" }}>
            <div ref={whyHeadRef} style={{ opacity: 0, textAlign: "center", marginBottom: 56 }}>
              ...
              <h2 style={{ fontSize: "clamp(1.875rem, 3vw, 2.75rem)", fontWeight: 700, color: "#111", marginBottom: 14 }}>
                Your Partner in Entry Security<br />— Not Just an Installer
              </h2>
        ...
        <section style={{ position: "relative", overflow: "hidden", padding: "7rem 0", backgroundColor: "var(--background)" }}>
          <div style={{ position: "absolute", inset: 0 }}>
            <img src="https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=1600&q=80" alt="" style={{ width: "100%", height: "100%", objectFit: "cover", opacity: 0.07 }} />
          ...
          <div style={{ position: "relative", zIndex: 10, maxWidth: 720, margin: "0 auto", padding: "0 1.5rem", textAlign: "center" }}>
            <div ref={ctaRef} style={{ opacity: 0 }}>
              <div style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "5px 14px", borderRadius: "9999px", border: "1px solid var(--primary-30-border)", backgroundColor: "var(--primary-05-bg)", color: "var(--primary)", fontSize: "0.72rem", fontWeight: 700, marginBottom: 24, letterSpacing: "0.14em", textTransform: "uppercase" }}>
                <span style={{ width: 6, height: 6, borderRadius: "50%", backgroundColor: "var(--primary)", display: "inline-block" }} />
                Ready to secure your entrance?
              </div>
              <h2 style={{ fontSize: "clamp(2rem, 4vw, 3rem)", fontWeight: 700, color: "var(--foreground)", marginBottom: 20, lineHeight: 1.15 }}>
                See, Speak, and Secure —<br />From Anywhere in Your Property
              </h2>
              <p style={{ color: "var(--text-muted)", fontSize: "1.05rem", lineHeight: 1.8, marginBottom: 40 }}>
                Cloud CompCon installs professional video door phone systems for homes, offices, and institutions. Let us assess your property and recommend the right solution for your needs.
              </p>
