...
const DELIVERY_MODELS = [
  {
    ...
    desc: "Ready-to-use applications delivered over the internet — no installation, no maintenance. Simply log in and get to work. Ideal for CRM, email, collaboration tools and more.",
  ...
  },
  {
    ...
    desc: "A complete development and deployment environment in the cloud. Build, test and ship your applications without managing the underlying infrastructure — focus on code, not servers.",
    icon: "M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4",
    img: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=800&q=80",
    examples: ["AWS Elastic Beanstalk", "Google App Engine", "Microsoft Azure", "Heroku"],
  },
  {
    acronym: "IaaS",
    name: "Infrastructure as a Service",
    desc: "Virtualised computing resources over the internet — servers, storage, networking — on demand. Scale your infrastructure up or down as easily as switching data on your smartphone.",
...
const BENEFITS = [
  {
    ...
    body: "With cloud-based IT solutions, you pay only for what you need — which can save significant money versus maintaining on-premise hardware and software licences.",
  ...
  },
  {
    ...
    body: "Upgrades are automatic in the cloud. No downtime windows, no manual patching, no waiting — your systems are always running on the latest, most secure version.",
    icon: "M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15",
    img: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=600&q=80",
  },
  {
    title: "Scale Instantly",
    body: "Scaling up — or down — is as easy as switching data ON or OFF on your smartphone. Handle millions of customer queries one day, scale back the next. No wasted capacity.",
    icon: "M13 10V3L4 14h7v7l9-11h-7z",
    img: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=600&q=80",
  },
  {
    title: "Reduce Complexity",
    body: "No in-house team needed to install, configure, test, secure, and update traditional enterprise applications. Your Managed Service Provider handles all of that for you.",
    icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z",
    img: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=600&q=80",
  },
  {
    title: "Up and Running Immediately",
    body: "Cloud-based applications can be up and running right away — no lengthy procurement, installation, or configuration cycles. Get productive from day one.",
    icon: "M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z",
    img: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=600&q=80",
  },
  {
    title: "Economies of Scale",
    body: "Take advantage of the economies of scale that only cloud providers can offer — world-class infrastructure at a fraction of what it would cost to build and maintain yourself.",
...
// ── Gallery ──
const GALLERY = [
  { label: "Cloud Infrastructure", img: "https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=700&q=80", span: 2 },
  { label: "Data Centres",         img: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=700&q=80", span: 1 },
  { label: "Managed Services",     img: "https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=700&q=80", span: 1 },
  { label: "Scalable Solutions",   img: "https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=700&q=80", span: 2 },
];

// ── Why choose Cloud CompCon ──
const WHY = [
  { stat: "MSP",  label: "Managed Service Provider",    desc: "We take care of hardware, software, security and updates so you can focus on running your business." },
  { stat: "24/7", label: "Always-On Infrastructure",    desc: "Your cloud environment monitored and managed around the clock — no outages, no surprises." },
  { stat: "Flex", label: "Flexible Operating Models",   desc: "Personalised to your operating hours and specific business needs — not a one-size-fits-all package." },
  { stat: "Cost", label: "Reduce IT Expenditure",       desc: "Pay only for what you use. No capital expenditure on hardware, no surprise maintenance bills." },
];

export default function ITCloudSolutions() {
      ...
      <main style={{ paddingTop: "var(--nav-height)" }}>
          ...
          <div style={{ position: "relative", zIndex: 10, maxWidth: "var(--max-width)", margin: "0 auto", padding: "0 1.5rem", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 56, alignItems: "center" }}>
            ...
            <div>
              <div ref={introBadgeRef} style={{ opacity: 0, display: "inline-flex", alignItems: "center", gap: 8, padding: "5px 14px", borderRadius: "9999px", border: "1px solid var(--primary-30-border)", backgroundColor: "var(--primary-05-bg)", color: "var(--primary)", fontSize: "0.72rem", fontWeight: 700, marginBottom: 28, letterSpacing: "0.14em", textTransform: "uppercase" }}>
                ...
                Network Services · IT Cloud Solutions
              </div>
              ...
              <p ref={introParaRef} style={{ opacity: 0, fontSize: "1.1rem", color: "var(--text-muted)", marginBottom: 40, maxWidth: 520, lineHeight: 1.85 }}>
                Today, cloud-based IT solutions are the talk of the world. Cloud CompCon is your{" "}
                <strong style={{ color: "var(--foreground)" }}>Managed Service Provider (MSP)</strong> — handling the hardware, software, security and updates so you can concentrate on your core business, not day-to-day technology headaches.
              </p>
              <div ref={introBtnsRef} style={{ opacity: 0, display: "flex", gap: 16, flexWrap: "wrap" }}>
                <MagneticButton primary href="/contact">Talk to an Expert</MagneticButton>
                <MagneticButton href="#benefits">See the Benefits</MagneticButton>
              </div>
            </div>

            {/* Right — cloud infra visual */}
            <div ref={introImgRef} style={{ opacity: 0, position: "relative" }}>
              <div style={{ borderRadius: "1rem", overflow: "hidden", border: "1px solid var(--border-subtle)", boxShadow: "0 32px 64px rgba(0,0,0,0.5)" }}>
                ...
                <div style={{ padding: "12px 16px", borderBottom: "1px solid var(--border-subtle)", display: "flex", alignItems: "center", justifyContent: "space-between", backgroundColor: "rgba(255,255,255,0.03)" }}>
                  ...
                  <span style={{ fontSize: "0.7rem", color: "var(--text-subtle)", fontWeight: 600 }}>Cloud Infrastructure</span>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", borderTop: "1px solid var(--border-subtle)", backgroundColor: "var(--surface)" }}>
                  {[
                    { val: "SaaS", lbl: "Software Layer" },
                    { val: "PaaS", lbl: "Platform Layer" },
                    { val: "IaaS", lbl: "Infrastructure" },
                  ].map((s, i) => (
              ...
              <div style={{ position: "absolute", top: -22, right: -22, width: 90, height: 90, borderRadius: "50%", overflow: "hidden", border: "3px solid var(--background)", boxShadow: "0 8px 24px rgba(0,0,0,0.4)" }}>
                <img src="https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=300&q=80" alt="" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
              </div>
            </div>
          </div>
        </section>
        ...
        <section style={{ padding: "3.5rem 0", backgroundColor: "#ffffff", borderTop: "1px solid #e5e7eb", borderBottom: "1px solid #e5e7eb" }}>
          <div style={{ maxWidth: "var(--max-width)", margin: "0 auto", padding: "0 1.5rem" }}>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", borderRadius: "1rem", overflow: "hidden", border: "1px solid #e5e7eb" }}>
              {[
                { icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z", text: "Fully managed — no in-house IT team needed" },
                { icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z",                                                text: "Pay only for what you use" },
                { icon: "M13 10V3L4 14h7v7l9-11h-7z",                                                                                                                                                                                                                                                                            text: "Scale up or down in minutes" },
                { icon: "M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15",                                                                                                                                                                                           text: "Automatic upgrades — always up to date" },
              ].map((item, i) => (
          ...
          <div style={{ maxWidth: "var(--max-width)", margin: "0 auto", padding: "0 1.5rem", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 72, alignItems: "center" }}>
            ...
            <div style={{ position: "relative" }}>
              <div style={{ borderRadius: "1rem", overflow: "hidden", boxShadow: "0 20px 60px rgba(0,0,0,0.12)" }}>
                <img src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=900&q=80" alt="Cloud Computing" style={{ width: "100%", height: 420, objectFit: "cover", display: "block" }} />
              </div>
              {/* Floating badge */}
              <div style={{ position: "absolute", bottom: -20, right: -20, padding: "16px 22px", borderRadius: "1rem", backgroundColor: "var(--primary)", boxShadow: "0 12px 32px rgba(129,194,63,0.4)" }}>
                ...
                <p style={{ fontSize: "0.78rem", fontWeight: 700, color: "#0a0a0a" }}>Delivery Models</p>
              </div>
              ...
              <div style={{ position: "absolute", top: -20, left: -20, padding: "14px 18px", borderRadius: "1rem", backgroundColor: "#0a0a0a", border: "1px solid rgba(129,194,63,0.3)", boxShadow: "0 8px 24px rgba(0,0,0,0.3)" }}>
                <p style={{ fontSize: "0.72rem", fontWeight: 700, color: "var(--primary)", marginBottom: 2 }}>Board-level priority</p>
                <p style={{ fontSize: "0.68rem", color: "rgba(255,255,255,0.6)" }}>Recognised globally</p>
              </div>
            </div>

            {/* Right — text */}
            <div>
              <p style={{ fontSize: "0.72rem", fontWeight: 700, color: "var(--primary)", letterSpacing: "0.18em", textTransform: "uppercase", marginBottom: 14 }}>What Is IT Cloud?</p>
              <h2 style={{ fontSize: "clamp(1.75rem, 2.8vw, 2.4rem)", fontWeight: 700, color: "#111", lineHeight: 1.2, marginBottom: 20 }}>
                The World Is Moving<br />to the Cloud — Is Your Business?
              </h2>
              <p style={{ color: "#555", lineHeight: 1.85, marginBottom: 18, fontSize: "0.95rem" }}>
                Cloud computing is no longer just IT department talk — it's a board-level priority. Senior executives worldwide now recognise how cloud-based IT solutions help organisations <strong>reduce expenses, boost profitability, and expand operations</strong>.
              </p>
              <p style={{ color: "#555", lineHeight: 1.85, marginBottom: 18, fontSize: "0.95rem" }}>
                Traditional enterprise applications are complicated and costly: you need an in-house team to install, configure, test, run, secure, and update everything. With cloud-based solutions, that headache disappears entirely — because <strong>your MSP handles all of that for you</strong>.
              </p>
              <p style={{ color: "#555", lineHeight: 1.85, marginBottom: 32, fontSize: "0.95rem" }}>
                Whether you're running applications that handle millions of customer queries or supporting critical business operations, Cloud CompCon provides a <strong style={{ color: "var(--primary)" }}>better way to manage your business</strong>.
              </p>
              <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                {[
                  "No hardware to buy, manage or replace",
                  "Flexible operating models personalised to your hours and needs",
                  "Concentrate on your core business — not technology issues",
                ].map((pt, i) => (
        ...
        <section id="benefits" style={{ padding: "6rem 0", backgroundColor: "#f9fafb", borderTop: "1px solid #e5e7eb" }}>
          <div style={{ maxWidth: "var(--max-width)", margin: "0 auto", padding: "0 1.5rem" }}>
            <div ref={benefitHeadRef} style={{ opacity: 0, textAlign: "center", marginBottom: 56 }}>
              <p style={{ fontSize: "0.75rem", fontWeight: 700, color: "var(--primary)", letterSpacing: "0.18em", textTransform: "uppercase", marginBottom: 10 }}>Why Cloud</p>
              ...
              <p style={{ color: "#555", maxWidth: 560, margin: "0 auto", lineHeight: 1.8 }}>
                Cloud-based solutions are much more affordable than traditional software, and they're available immediately — with no setup, no procurement delays, and no hidden infrastructure costs.
              </p>
        ...
        <section style={{ padding: "6rem 0", backgroundColor: "#ffffff", borderTop: "1px solid #e5e7eb" }}>
          <div style={{ maxWidth: "var(--max-width)", margin: "0 auto", padding: "0 1.5rem" }}>
            <div ref={modelHeadRef} style={{ opacity: 0, textAlign: "center", marginBottom: 64 }}>
              <p style={{ fontSize: "0.75rem", fontWeight: 700, color: "var(--primary)", letterSpacing: "0.18em", textTransform: "uppercase", marginBottom: 10 }}>Delivery Methods</p>
              <h2 style={{ fontSize: "clamp(1.875rem, 3vw, 2.75rem)", fontWeight: 700, color: "#111", marginBottom: 16 }}>
                IT Cloud Solutions Delivery Models
              </h2>
              <p style={{ color: "#555", maxWidth: 560, margin: "0 auto", lineHeight: 1.8 }}>
                Cloud-based IT solutions are delivered via three main models — each with its own share of advantages depending on your business needs.
              </p>
              <div style={{ width: 72, height: 5, backgroundColor: "var(--primary)", margin: "22px auto 0", borderRadius: 9999 }} />
            </div>
        ...
        <section style={{ padding: "6rem 0", backgroundColor: "var(--background)", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative", zIndex: 10, maxWidth: "var(--max-width)", margin: "0 auto", padding: "0 1.5rem" }}>
            <div ref={galleryHeadRef} style={{ opacity: 0, textAlign: "center", marginBottom: 48 }}>
              <p style={{ fontSize: "0.75rem", fontWeight: 700, color: "var(--primary)", letterSpacing: "0.18em", textTransform: "uppercase", marginBottom: 10 }}>What We Manage</p>
              <h2 style={{ fontSize: "clamp(1.875rem, 3vw, 2.75rem)", fontWeight: 700, color: "var(--foreground)", marginBottom: 14 }}>
                Enterprise-Grade Infrastructure<br />Without the Enterprise Complexity
              </h2>
              <p style={{ color: "var(--text-muted)", maxWidth: 500, margin: "0 auto", lineHeight: 1.75 }}>
                We handle the full stack — from physical infrastructure and data centres to the software your team relies on daily.
              </p>
              <div style={{ width: 72, height: 5, backgroundColor: "var(--primary)", margin: "22px auto 0", borderRadius: 9999 }} />
            </div>
        ...
        <section style={{ backgroundColor: "var(--primary)", padding: "5rem 0", overflow: "hidden", position: "relative" }}>
          ...
          <div style={{ position: "absolute", top: 0, right: 0, width: "28%", height: "100%", overflow: "hidden", opacity: 0.15 }}>
            <img src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=600&q=80" alt="" style={{ width: "100%", height: "100%", objectFit: "cover" }} />
          </div>
          <div style={{ position: "relative", zIndex: 10, maxWidth: "var(--max-width)", margin: "0 auto", padding: "0 1.5rem", display: "flex", flexWrap: "wrap", gap: 48, alignItems: "center", justifyContent: "space-between" }}>
            <div style={{ flex: 1, minWidth: 260 }}>
              <p style={{ fontSize: "0.72rem", fontWeight: 700, color: "rgba(0,0,0,0.5)", letterSpacing: "0.18em", textTransform: "uppercase", marginBottom: 12 }}>Your MSP partner</p>
              <h2 style={{ fontSize: "clamp(2rem, 4vw, 3rem)", fontWeight: 700, color: "#0a0a0a", lineHeight: 1.15, marginBottom: 20 }}>
                Choosing the right MSP<br />is a critical business decision
              </h2>
              <p style={{ color: "rgba(0,0,0,0.72)", fontSize: "1.05rem", lineHeight: 1.8, maxWidth: 520 }}>
                Adopting cloud-based IT is one of the most important decisions your organisation will make. Cloud CompCon offers the <strong>flexibility, expertise and personalised operating models</strong> you need to maximise your investment and achieve your business goals.
              </p>
            </div>
          ...
          <div style={{ maxWidth: "var(--max-width)", margin: "0 auto", padding: "0 1.5rem" }}>
            <div ref={whyHeadRef} style={{ opacity: 0, textAlign: "center", marginBottom: 56 }}>
              ...
              <h2 style={{ fontSize: "clamp(1.875rem, 3vw, 2.75rem)", fontWeight: 700, color: "#111", marginBottom: 14 }}>
                Your Partner in Cloud<br />— Not Just a Vendor
              </h2>
        ...
        <section style={{ position: "relative", overflow: "hidden", padding: "7rem 0", backgroundColor: "var(--background)" }}>
          <div style={{ position: "absolute", inset: 0 }}>
            <img src="https://images.unsplash.com/photo-1451187580459-43490279c0fa?w=1600&q=80" alt="" style={{ width: "100%", height: "100%", objectFit: "cover", opacity: 0.07 }} />
          ...
          <div style={{ position: "relative", zIndex: 10, maxWidth: 720, margin: "0 auto", padding: "0 1.5rem", textAlign: "center" }}>
            <div ref={ctaRef} style={{ opacity: 0 }}>
              ...
              <h2 style={{ fontSize: "clamp(2rem, 4vw, 3rem)", fontWeight: 700, color: "var(--foreground)", marginBottom: 20, lineHeight: 1.15 }}>
                Let's Move Your Business<br />to the Cloud
              </h2>
              <p style={{ color: "var(--text-muted)", fontSize: "1.05rem", lineHeight: 1.8, marginBottom: 40 }}>
                Cloud CompCon provides a new — and better — way to manage your business. Flexible, affordable, and fully managed. Let's meet and find the right cloud solution for you.
              </p>
  ...
  return (
    ...
    >
      ...
      <div style={{ flex: "0 0 280px", minHeight: 220, position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ position: "absolute", inset: 0, background: "linear-gradient(135deg, rgba(0,0,0,0.55) 0%, transparent 60%)", transition: "opacity 0.3s" }} />
      ...
      <div style={{ flex: 1, minWidth: 260, padding: "32px 36px", backgroundColor: "#fff" }}>
        ...
        {/* Examples row */}
        <div>
          <p style={{ fontSize: "0.7rem", fontWeight: 700, color: "#9ca3af", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 8 }}>Examples</p>
